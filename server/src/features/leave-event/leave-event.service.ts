...
import { hasRunningBalance, isEligible, LeaveTypeNotFound } from '../leave-type/leave-type.js';
...
import type { LeaveEventListOptions, LeaveEventRepository } from './leave-event.db.js';
...
import type { BalanceService, EventGranted } from '../balance/balance.service.js';
...
export class LeaveEventService {
  constructor(
     ...
     * ../features/balance/ledger.service.ts gives about the employee repository it holds: this
